...
export function DreamGraze(props) {
  const { nodes, materials } = useGLTF('/DreamGraze.glb')
  ...
  return (
    ...
    <group ref={fullWindow}{...props} dispose={null}>
      ...
      <group visible={false}>
        <mesh geometry={nodes.American_Brown.geometry} material={materials.AmericanBrown} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Beige.geometry} material={materials['Beige.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Black.geometry} material={materials['Black.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Burgundy.geometry} material={materials['Burgundy.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Cashmere.geometry} material={materials['Cashmere.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Clay.geometry} material={materials['Clay.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Cranberry.geometry} material={materials['Cranberry.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Ivory.geometry} material={materials['Ivory.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.OldWorldBlue.geometry} material={materials['OldWorldBlue.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Sable.geometry} material={materials['Sable.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Sandalwood.geometry} material={materials['Sandalwood.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Sandtone.geometry} material={materials['Sandtone.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.UniversalBrown.geometry} material={materials['UniversalBrown.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.WedgeWoodBlue.geometry} material={materials['OldWorldBlue.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.Wicker.geometry} material={materials['Wicker.001']} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.OakWood.geometry} material={materials.OakWood} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.BrazilianCherryWood.geometry} material={materials.BrazilianCherryWood} position={[0, 0.006, 0]} />
        <mesh geometry={nodes.ProvincialWood.geometry} material={materials.ProvincialWood} position={[0.09, -0.443, 0]} />
    ...
    //   <mesh geometry={nodes.glass2.geometry} material={materials['glass.001']} position={[0.016, -0.296, 0.226]} />
    //   <mesh geometry={nodes.glass1.geometry} material={materials['glass.001']} position={[-0.01, -0.003, 0.21]} />
    //   <mesh geometry={nodes.Cube011.geometry} material={materials.color2} position={[0.001, 0.006, 0]} />
    //   <mesh geometry={nodes.frame2_p1.geometry} material={materials.color2} position={[0.016, -0.296, 0.226]} />
    ...
    //   <mesh geometry={nodes.screen_glass1_half.geometry} material={materials['glass.001']} position={[0, 0.006, 0]} />
    //   <mesh geometry={nodes.screen_frame_full.geometry} material={materials.White} position={[-0.002, 0.006, 0]} />
    //   <mesh geometry={nodes.screen_glass1_full.geometry} material={materials['glass.001']} position={[0, 0.006, 0]} />
    //   <mesh geometry={nodes.bottomblack.geometry} material={materials.black} position={[0, 0.006, 0]} />
...
useGLTF.preload('/DreamGraze.glb')
